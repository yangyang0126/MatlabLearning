test MATLAB .NET Assembly (.NET Component)
...
test_overview.html - HTML overview documentation file for the generated component. It 
                     contains the requirements for accessing the component and for 
                     generating arguments using the MWArray class hierarchy.

test.xml - This file contains the code comments for the test component classes and 
                     ...
                     online documentation for the test component.
